...
from torch.cuda import stream #import set_stream
import rospy
from cv_bridge import CvBridge
from sensor_msgs.msg import Image
from rospy.numpy_msg import numpy_msg
from rospy_tutorials.msg import Floats
from std_msgs.msg import Int32MultiArray, String, Int32, MultiArrayDimension
...
class yolo_for_ros():
    def __init__(self, yolo_weight,  # model.pt path(s)
        ...
        #self.pub_landmark = rospy.Publisher("/AVM_detected_landmarks", Int32MultiArray, queue_size=10)
    ...
    def run(self, input_img, yolo_weight='yolov5s.pt',  # model.pt path(s)
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                outputs = self.deepsort.update(xywhs.cpu(), confs.cpu(), clss, im0)
                ...
                if len(outputs) > 0:
                    ...
                    for j, (output, conf) in enumerate(zip(outputs, confs)): 
                        ...
                        refine_estimations.append(np.array([c,center_point[0],center_point[1],id]))
    ...
    def listener(self):
        ...
        rospy.Subscriber("/AVM_side_image", Image, self.image_callback) #for ocam & carla --> center
...
def parse_opt():
    ...
    parser.add_argument('--refinement_weight', nargs='+', type=str, default='train_ABC_resize_80_crop_45_55_20_resnet18/200_epoch_model.pth', help='model.pt path(s)') #refinement weight
    parser.add_argument('--deep_sort_weights', type=str, default='deep_sort_pytorch/deep_sort/deep/checkpoint/ckpt.t7', help='ckpt.t7 path') #deepsort weight
